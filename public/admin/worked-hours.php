...
<head>
    ...
    <link rel="stylesheet" href="css/styles.css">
    <link rel="stylesheet" href="css/worked-hours.css">
    <link rel="icon" type="image/x-icon" href="../images/favicon.ico"/>
    <title>Fugafix Admin | Horas laboradas</title>
</head>
<body>
...
<main>
    ...
    <article id="filter-article" class="inline-flex gap-12">
        ...
        <div id="balance" class="inline-flex items-center gap-2">
            <h2>Horas totales laboradas: </h2>
            <p>120 horas</p>
        </div>
    </article>
    <section id="services">
        <div class="inline-flex gap-x-16">
            <article id="service-1-article">
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex gap-2 items-baseline text-gray-900 dark:text-white">
                        <span class="text-5xl font-extrabold tracking-tight">4:30</span>
                        <span class="text-3xl font-semibold">horas</span>
                    </div>
                    <ul role="list" class="space-y-5 my-7">
                        ...
                        <li class="flex">
                            ...
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Hora inicio: 00:00</span>
                        </li>
                        <li class="flex">
                            <svg class="flex-shrink-0 w-4 h-4 color-accent-200" aria-hidden="true"
                                 xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Hora fin: 04:30</span>
                        </li>
                    </ul>
                </div>
            </article>
