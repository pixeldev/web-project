...
function goToAccount() {
    ...
    fetch(`http://localhost:3000/login/authenticated?id=${userId}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        }
        ...
        .then(async data => {
            ...
            const roleResponse = await fetch(`http://localhost:3000/user/role?userId=${userId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
...
function goToCreateRequest() {
    ...
    fetch(`http://localhost:3000/login/authenticated?id=${userId}`, {
        ...
        .then(async data => {
            ...
            const result = await fetch(`http://localhost:3000/user/service/active?userId=${userId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
